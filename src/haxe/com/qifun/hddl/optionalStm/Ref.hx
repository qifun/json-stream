...
abstract Ref<A>(scala.concurrent.stm.Ref<A>)
{
  ...
  static inline function toObjectRef<A:{}>(t:scala.concurrent.stm.Ref<A>, initialValue:A):scala.concurrent.stm.Ref<A>
  {
    ...
    var dynamicRef:scala.concurrent.stm.Ref<Dynamic> = scala.concurrent.stm.Ref.RefSingleton.MODULE.apply((initialValue:Dynamic), classTag);
  ...
  {
    return cast scala.concurrent.stm.Ref.RefSingleton.MODULE.apply(initialValue);
  }
  ...
  {
    return cast scala.concurrent.stm.Ref.RefSingleton_Single.MODULE.apply(initialValue);
  }
}
