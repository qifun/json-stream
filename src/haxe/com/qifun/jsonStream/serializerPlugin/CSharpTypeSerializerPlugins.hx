...
@:final
class DictionaryCSSerializerPlugin
{
  #if cs
  ...
  {
    macro com.qifun.jsonStream.serializerPlugin.CSharpTypeSerializerPlugins.DictionaryCSSerializerPlugin.serializeForElement($self, function(subdata1) return subdata1.pluginSerialize(), function(subdata2) return subdata2.pluginSerialize());
  }
}
...
**/
@:final
class HashSetCSSerializerPlugin
{
  #if cs
  ...
  {
    macro com.qifun.jsonStream.serializerPlugin.CSharpTypeSerializerPlugins.HashSetCSSerializerPlugin.serializeForElement($self, function(subdata) return subdata.pluginSerialize());
  }
